...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Patient">
      <sch:assert test="count(f:extension[@url = 'http://agenda.cl/StructureDefinition/Edad']) &lt;= 1">extension with URL = 'http://agenda.cl/StructureDefinition/Edad': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://agenda.cl/StructureDefinition/Prevision']) &gt;= 1">extension with URL = 'http://agenda.cl/StructureDefinition/Prevision': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://agenda.cl/StructureDefinition/Prevision']) &lt;= 1">extension with URL = 'http://agenda.cl/StructureDefinition/Prevision': maximum cardinality of 'extension' is 1</sch:assert>
